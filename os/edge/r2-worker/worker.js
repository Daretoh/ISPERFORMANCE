// ============================================================
//  IS Performance OS - Puente de subida a Cloudflare R2
//  Cloudflare Worker. Recibe el archivo, valida que la sesión de Supabase
//  sea válida, y lo guarda en el bucket R2. Devuelve la "key" (ruta) guardada.
//  Los archivos se LEEN por la URL pública del bucket (pub-....r2.dev), no por
//  este Worker.
//
//  Necesita (se configura en Cloudflare, ver README):
//    - Binding R2:  Variable name = BUCKET  ->  bucket "isperformance-os"
//    - Variable    SUPABASE_URL   = https://<tu-proyecto>.supabase.co
//    - Variable    SUPABASE_ANON  = tu anon/publishable key de Supabase
// ============================================================
